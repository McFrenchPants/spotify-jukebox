 ...
 * At lg+, Now Playing + PlaybackControls form a left column paired with the
 * Up Next queue as a right column, matching the desktop mockup; lyrics (when
 * toggled) render as their own full-width section below both columns rather
 * than nested inside the Now Playing card, and that same grouping — lyrics
 * as a standalone section — is kept at every breakpoint, not just desktop.
 * Below lg this still just stacks in reading order. The "about the artist"
 * panel stays a lower-priority full-width addition at the very bottom.
